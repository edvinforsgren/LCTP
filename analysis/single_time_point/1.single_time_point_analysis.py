...
def run_all_data(df, moas, n_cvs, hour, epochs, layers, batch_size, learning_rate, activation_function, loss_function, drop_out, global_seed):
    pred_dfs = []
    ...
    with mp.Pool(processes=mp.cpu_count()) as pool:
        results = pool.starmap(process_compound,
            [(cv_idx, global_seed, df, moas, hour, epochs, layers, batch_size, learning_rate, activation_function, loss_function, drop_out)
...
if __name__  == "__main__":
    ...
    full_df, full_dmsos = run_all_data(df, moas, n_cvs, hour=hour, epochs=epochs, layers=layers, batch_size=batch_size, learning_rate=learning_rate, activation_function=activation, loss_function=loss_function, drop_out=drop_out, global_seed=seed)
